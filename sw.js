---
---
// Code from https://github.com/jeremiak/jekyll-offline
var urlsToCache = [];
  ...
  event.respondWith(
    caches.open(CACHE_NAME).then(function(cache) {
      return cache.match(event.request).then(function (response) {
        console.log('Trying to find response for :' + event.request.url)
        return response || fetch(event.request).then(function(response) {
          console.log('Did not find response, proxying request')
